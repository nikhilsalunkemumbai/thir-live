...
| **Generated At** | 2026-03-12T20:32:43Z |
...
| Metric | Value |
|---|---|
| Total Sessions Captured | **721** |
| Confirmed Threats | **469** |
| False Positives Filtered | **252** (34.9%) |
...
### 🔴 HIGH · IR-cd728508e2c4

| Field | Detail |
|---|---|
| **Source IP** | `118.193.36[.]205` |
| **First Seen** | 2026-03-12 15:13 |
| **Last Seen** | 2026-03-12 15:13 |
| **Session Duration** | 3s |
| **Login Attempts** | 1 |
| **Auth Success** | ✅ Yes — session established |
| **Commands Executed** | `cd ~; chattr -ia .ssh; lockr -ia .ssh, cd ~ && rm -rf .ssh && mkdir .ssh && echo "ssh-rsa  mdrfckr">>.ssh/authorized_keys && chmod -R go= ~/.ssh && cd ~` |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-12 15:13:14` | `cowrie.session.connect` |
| `2026-03-12 15:13:14` | `cowrie.client.version` |
| `2026-03-12 15:13:14` | `cowrie.client.kex` |
| `2026-03-12 15:13:15` | `cowrie.login.success` |
| `2026-03-12 15:13:15` | `cowrie.session.params` |
| `2026-03-12 15:13:15` | `cowrie.command.input` |
| `2026-03-12 15:13:15` | `cowrie.command.failed` |
| `2026-03-12 15:13:15` | `cowrie.log.closed` |
| `2026-03-12 15:13:15` | `cowrie.session.params` |
| `2026-03-12 15:13:15` | `cowrie.command.input` |
| `2026-03-12 15:13:16` | `cowrie.session.file_download` |
| `2026-03-12 15:13:16` | `cowrie.log.closed` |
| `2026-03-12 15:13:18` | `cowrie.session.closed` |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-12 15:13:17` | `cowrie.session.connect` |
| `2026-03-12 15:13:17` | `cowrie.client.version` |
| `2026-03-12 15:13:17` | `cowrie.client.kex` |
| `2026-03-12 15:13:18` | `cowrie.login.success` |
| `2026-03-12 15:13:18` | `cowrie.session.closed` |
...
### 🔴 HIGH · IR-5c31f475f0f5

| Field | Detail |
|---|---|
| **Source IP** | `66.154.119[.]88` |
| **First Seen** | 2026-03-12 15:17 |
| **Last Seen** | 2026-03-12 15:17 |
| **Session Duration** | 1s |
| **Login Attempts** | 1 |
| **Auth Success** | ✅ Yes — session established |
| **TTPs (MITRE)** | T1078 · T1592 |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-12 15:17:19` | `cowrie.session.connect` |
| `2026-03-12 15:17:19` | `cowrie.client.version` |
| `2026-03-12 15:17:19` | `cowrie.client.kex` |
| `2026-03-12 15:17:20` | `cowrie.login.success` |
| `2026-03-12 15:17:20` | `cowrie.session.closed` |

**Recommended Actions:**
- [ ] Submit `66.154.119[.]88` to AbuseIPDB if not already reported
- [ ] Block `66.154.119[.]88` at perimeter firewall / security group
- [ ] Escalate to Tier 2 if pattern repeats next shift

### 🔴 HIGH · IR-718b2301f577

| Field | Detail |
|---|---|
| **Source IP** | `170.64.157[.]123` |
| **First Seen** | 2026-03-12 15:36 |
| **Last Seen** | 2026-03-12 15:37 |
| **Session Duration** | 4s |
| **Login Attempts** | 1 |
| **Auth Success** | ✅ Yes — session established |
| **Commands Executed** | `export PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:$PATH; uname=$(uname -s -v -n -m 2>/dev/null); arch=$(uname -m 2>/dev/null); uptime=$(cat /proc/uptime 2>/dev/null | cut -d. -f1); cpus=$( (nproc 2>/dev/null || /usr/bin/nproc 2>/dev/null || grep -c "^processor" /proc/cpuinfo 2>/dev/null) | head -1); cpu_model=$( (grep -m1 -E "model name|Hardware" /proc/cpuinfo | cut -d: -f2- | sed 's/^ *//;s/ *$//' ; lscpu 2>/dev/null | awk -F: '/Model name/ {gsub(/^ +| +$/,"",$2); print $2; exit}' ; , uname -s -v -n -m 2 > /dev/null, uname -m 2 > /dev/null, cat /proc/uptime 2 > /dev/null | cut -d. -f1` |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-12 15:36:58` | `cowrie.session.connect` |
| `2026-03-12 15:36:58` | `cowrie.client.version` |
| `2026-03-12 15:36:58` | `cowrie.client.kex` |
| `2026-03-12 15:37:00` | `cowrie.login.success` |
| `2026-03-12 15:37:02` | `cowrie.session.params` |
| `2026-03-12 15:37:02` | `cowrie.command.input` |
| `2026-03-12 15:37:02` | `cowrie.command.input` |
| `2026-03-12 15:37:02` | `cowrie.command.input` |
| `2026-03-12 15:37:02` | `cowrie.command.input` |
| `2026-03-12 15:37:02` | `cowrie.log.closed` |
| `2026-03-12 15:37:03` | `cowrie.session.closed` |

**Recommended Actions:**
- [ ] Submit `170.64.157[.]123` to AbuseIPDB if not already reported
- [ ] Block `170.64.157[.]123` at perimeter firewall / security group
- [ ] Review commands for lateral movement indicators
- [ ] Escalate to Tier 2 if pattern repeats next shift

### 🔴 HIGH · IR-96b6aad2ff2b

| Field | Detail |
|---|---|
| **Source IP** | `170.64.157[.]123` |
| **First Seen** | 2026-03-12 15:38 |
| **Last Seen** | 2026-03-12 15:38 |
| **Session Duration** | 4s |
| **Login Attempts** | 1 |
| **Auth Success** | ✅ Yes — session established |
| **Commands Executed** | `export PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:$PATH; uname=$(uname -s -v -n -m 2>/dev/null); arch=$(uname -m 2>/dev/null); uptime=$(cat /proc/uptime 2>/dev/null | cut -d. -f1); cpus=$( (nproc 2>/dev/null || /usr/bin/nproc 2>/dev/null || grep -c "^processor" /proc/cpuinfo 2>/dev/null) | head -1); cpu_model=$( (grep -m1 -E "model name|Hardware" /proc/cpuinfo | cut -d: -f2- | sed 's/^ *//;s/ *$//' ; lscpu 2>/dev/null | awk -F: '/Model name/ {gsub(/^ +| +$/,"",$2); print $2; exit}' ; , uname -s -v -n -m 2 > /dev/null, uname -m 2 > /dev/null, cat /proc/uptime 2 > /dev/null | cut -d. -f1` |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-12 15:38:01` | `cowrie.session.connect` |
| `2026-03-12 15:38:01` | `cowrie.client.version` |
| `2026-03-12 15:38:01` | `cowrie.client.kex` |
| `2026-03-12 15:38:04` | `cowrie.login.success` |
| `2026-03-12 15:38:05` | `cowrie.session.params` |
| `2026-03-12 15:38:05` | `cowrie.command.input` |
| `2026-03-12 15:38:05` | `cowrie.command.input` |
| `2026-03-12 15:38:05` | `cowrie.command.input` |
| `2026-03-12 15:38:05` | `cowrie.command.input` |
| `2026-03-12 15:38:06` | `cowrie.log.closed` |
| `2026-03-12 15:38:06` | `cowrie.session.closed` |
...
### 🔴 HIGH · IR-216eb9d09441

| Field | Detail |
|---|---|
| **Source IP** | `170.64.157[.]123` |
| **First Seen** | 2026-03-12 15:39 |
| **Last Seen** | 2026-03-12 15:39 |
| **Session Duration** | 3s |
| **Login Attempts** | 1 |
| **Auth Success** | ✅ Yes — session established |
| **Commands Executed** | `export PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:$PATH; uname=$(uname -s -v -n -m 2>/dev/null); arch=$(uname -m 2>/dev/null); uptime=$(cat /proc/uptime 2>/dev/null | cut -d. -f1); cpus=$( (nproc 2>/dev/null || /usr/bin/nproc 2>/dev/null || grep -c "^processor" /proc/cpuinfo 2>/dev/null) | head -1); cpu_model=$( (grep -m1 -E "model name|Hardware" /proc/cpuinfo | cut -d: -f2- | sed 's/^ *//;s/ *$//' ; lscpu 2>/dev/null | awk -F: '/Model name/ {gsub(/^ +| +$/,"",$2); print $2; exit}' ; , uname -s -v -n -m 2 > /dev/null, uname -m 2 > /dev/null, cat /proc/uptime 2 > /dev/null | cut -d. -f1` |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-12 15:39:06` | `cowrie.session.connect` |
| `2026-03-12 15:39:06` | `cowrie.client.version` |
| `2026-03-12 15:39:07` | `cowrie.client.kex` |
| `2026-03-12 15:39:08` | `cowrie.login.success` |
| `2026-03-12 15:39:08` | `cowrie.session.params` |
| `2026-03-12 15:39:08` | `cowrie.command.input` |
| `2026-03-12 15:39:08` | `cowrie.command.input` |
| `2026-03-12 15:39:08` | `cowrie.command.input` |
| `2026-03-12 15:39:08` | `cowrie.command.input` |
| `2026-03-12 15:39:09` | `cowrie.log.closed` |
| `2026-03-12 15:39:10` | `cowrie.session.closed` |
...
### 🔴 HIGH · IR-d7d5db4aa026

| Field | Detail |
|---|---|
| **Source IP** | `221.182.17[.]158` |
| **First Seen** | 2026-03-12 16:42 |
| **Last Seen** | 2026-03-12 16:42 |
| **Session Duration** | 1s |
| **Login Attempts** | 1 |
| **Auth Success** | ✅ Yes — session established |
| **TTPs (MITRE)** | T1078 · T1592 |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-12 16:42:33` | `cowrie.session.connect` |
| `2026-03-12 16:42:33` | `cowrie.client.version` |
| `2026-03-12 16:42:34` | `cowrie.client.kex` |
| `2026-03-12 16:42:35` | `cowrie.login.success` |
| `2026-03-12 16:42:35` | `cowrie.session.closed` |
...
### 🔴 HIGH · IR-e779ed396708

| Field | Detail |
|---|---|
| **Source IP** | `159.203.12[.]51` |
| **First Seen** | 2026-03-12 16:42 |
| **Last Seen** | 2026-03-12 16:42 |
| **Session Duration** | 1s |
| **Login Attempts** | 1 |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-12 16:42:46` | `cowrie.session.connect` |
| `2026-03-12 16:42:46` | `cowrie.client.version` |
| `2026-03-12 16:42:46` | `cowrie.client.kex` |
| `2026-03-12 16:42:47` | `cowrie.login.success` |
| `2026-03-12 16:42:48` | `cowrie.session.params` |
| `2026-03-12 16:42:48` | `cowrie.command.input` |
| `2026-03-12 16:42:48` | `cowrie.log.closed` |
| `2026-03-12 16:42:48` | `cowrie.session.closed` |

**Recommended Actions:**
- [ ] Submit `159.203.12[.]51` to AbuseIPDB if not already reported
- [ ] Block `159.203.12[.]51` at perimeter firewall / security group
- [ ] Review commands for lateral movement indicators
- [ ] Escalate to Tier 2 if pattern repeats next shift
...
### 🔴 HIGH · IR-dcb7d89f6020

| Field | Detail |
|---|---|
| **Source IP** | `116.50.179[.]74` |
| **First Seen** | 2026-03-12 19:26 |
| **Last Seen** | 2026-03-12 19:26 |
| **Session Duration** | 3s |
| **Login Attempts** | 1 |
| **Auth Success** | ✅ Yes — session established |
| **Commands Executed** | `cd ~; chattr -ia .ssh; lockr -ia .ssh, cd ~ && rm -rf .ssh && mkdir .ssh && echo "ssh-rsa  mdrfckr">>.ssh/authorized_keys && chmod -R go= ~/.ssh && cd ~` |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-12 19:26:48` | `cowrie.session.connect` |
| `2026-03-12 19:26:48` | `cowrie.client.version` |
| `2026-03-12 19:26:48` | `cowrie.client.kex` |
| `2026-03-12 19:26:49` | `cowrie.login.success` |
| `2026-03-12 19:26:49` | `cowrie.session.params` |
| `2026-03-12 19:26:49` | `cowrie.command.input` |
| `2026-03-12 19:26:49` | `cowrie.command.failed` |
| `2026-03-12 19:26:49` | `cowrie.log.closed` |
| `2026-03-12 19:26:49` | `cowrie.session.params` |
| `2026-03-12 19:26:49` | `cowrie.command.input` |
| `2026-03-12 19:26:49` | `cowrie.session.file_download` |
| `2026-03-12 19:26:49` | `cowrie.log.closed` |
| `2026-03-12 19:26:52` | `cowrie.session.closed` |

**Recommended Actions:**
- [ ] Submit `116.50.179[.]74` to AbuseIPDB if not already reported
- [ ] Block `116.50.179[.]74` at perimeter firewall / security group
- [ ] Review commands for lateral movement indicators
- [ ] Submit download hash(es) to VirusTotal
- [ ] Escalate to Tier 2 if pattern repeats next shift

### 🔴 HIGH · IR-3cd4f06f0a47
...
| Time (UTC) | Event |
|---|---|
| `2026-03-12 19:26:51` | `cowrie.session.connect` |
| `2026-03-12 19:26:51` | `cowrie.client.version` |
| `2026-03-12 19:26:51` | `cowrie.client.kex` |
| `2026-03-12 19:26:52` | `cowrie.login.success` |
| `2026-03-12 19:26:52` | `cowrie.session.closed` |
...
### 🔴 HIGH · IR-927a50674aa8

| Field | Detail |
|---|---|
| **Source IP** | `116.50.179[.]74` |
| **First Seen** | 2026-03-12 19:35 |
| **Last Seen** | 2026-03-12 19:35 |
| **Session Duration** | 3s |
| **Login Attempts** | 1 |
| **Auth Success** | ✅ Yes — session established |
| **Commands Executed** | `cd ~; chattr -ia .ssh; lockr -ia .ssh, cd ~ && rm -rf .ssh && mkdir .ssh && echo "ssh-rsa  mdrfckr">>.ssh/authorized_keys && chmod -R go= ~/.ssh && cd ~` |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-12 19:35:32` | `cowrie.session.connect` |
| `2026-03-12 19:35:32` | `cowrie.client.version` |
| `2026-03-12 19:35:32` | `cowrie.client.kex` |
| `2026-03-12 19:35:33` | `cowrie.login.success` |
| `2026-03-12 19:35:33` | `cowrie.session.params` |
| `2026-03-12 19:35:33` | `cowrie.command.input` |
| `2026-03-12 19:35:33` | `cowrie.command.failed` |
| `2026-03-12 19:35:33` | `cowrie.log.closed` |
| `2026-03-12 19:35:33` | `cowrie.session.params` |
| `2026-03-12 19:35:33` | `cowrie.command.input` |
| `2026-03-12 19:35:34` | `cowrie.session.file_download` |
| `2026-03-12 19:35:34` | `cowrie.log.closed` |
| `2026-03-12 19:35:36` | `cowrie.session.closed` |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-12 19:35:35` | `cowrie.session.connect` |
| `2026-03-12 19:35:35` | `cowrie.client.version` |
| `2026-03-12 19:35:35` | `cowrie.client.kex` |
| `2026-03-12 19:35:36` | `cowrie.login.success` |
| `2026-03-12 19:35:36` | `cowrie.session.closed` |
...
### 🔴 HIGH · IR-2e1eb5f8b803

| Field | Detail |
|---|---|
| **Source IP** | `101.36.108[.]125` |
| **First Seen** | 2026-03-12 19:57 |
| **Last Seen** | 2026-03-12 19:57 |
| **Session Duration** | 3s |
| **Login Attempts** | 1 |
| **Auth Success** | ✅ Yes — session established |
| **Commands Executed** | `cd ~; chattr -ia .ssh; lockr -ia .ssh, cd ~ && rm -rf .ssh && mkdir .ssh && echo "ssh-rsa  mdrfckr">>.ssh/authorized_keys && chmod -R go= ~/.ssh && cd ~` |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-12 19:57:11` | `cowrie.session.connect` |
| `2026-03-12 19:57:11` | `cowrie.client.version` |
| `2026-03-12 19:57:11` | `cowrie.client.kex` |
| `2026-03-12 19:57:11` | `cowrie.login.success` |
| `2026-03-12 19:57:12` | `cowrie.session.params` |
| `2026-03-12 19:57:12` | `cowrie.command.input` |
| `2026-03-12 19:57:12` | `cowrie.command.failed` |
| `2026-03-12 19:57:12` | `cowrie.log.closed` |
| `2026-03-12 19:57:12` | `cowrie.session.params` |
| `2026-03-12 19:57:12` | `cowrie.command.input` |
| `2026-03-12 19:57:12` | `cowrie.session.file_download` |
| `2026-03-12 19:57:12` | `cowrie.log.closed` |
| `2026-03-12 19:57:15` | `cowrie.session.closed` |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-12 19:57:14` | `cowrie.session.connect` |
| `2026-03-12 19:57:14` | `cowrie.client.version` |
| `2026-03-12 19:57:14` | `cowrie.client.kex` |
| `2026-03-12 19:57:15` | `cowrie.login.success` |
| `2026-03-12 19:57:15` | `cowrie.session.closed` |
...
| `72.255.3[.]32` | **25** | 2026-03-12 19:33 | 2026-03-12 19:38 | 5m | 0 | `T1592` | 🟠 MEDIUM |
| `115.190.106[.]110` | **12** | 2026-03-12 19:15 | 2026-03-12 19:21 | 14m | 4 | `T1110.001 · T1592` | 🟠 MEDIUM |
| `116.50.179[.]74` | **12** | 2026-03-12 19:11 | 2026-03-12 19:39 | 0m | 12 | `T1110.001 · T1592` | 🟠 MEDIUM |
| `159.203.12[.]51` | **12** | 2026-03-12 16:37 | 2026-03-12 16:42 | 0m | 11 | `T1110.001 · T1592` | 🟠 MEDIUM |
| `180.76.184[.]79` | **12** | 2026-03-12 19:55 | 2026-03-12 20:04 | 10m | 6 | `T1110.001 · T1592` | 🟠 MEDIUM |
...
| `172.190.89[.]127` | **11** | 2026-03-12 17:06 | 2026-03-12 17:29 | 0m | 11 | `T1110.001 · T1592` | 🟠 MEDIUM |
| `179.33.210[.]213` | **11** | 2026-03-12 14:20 | 2026-03-12 14:46 | 0m | 11 | `T1110.001 · T1592` | 🟠 MEDIUM |
...
| `221.182.17[.]158` | **8** | 2026-03-12 16:42 | 2026-03-12 16:42 | 0m | 8 | `T1110.001 · T1592` | 🟢 LOW |
| `3.131.220[.]121` | **7** | 2026-03-12 17:28 | 2026-03-12 17:34 | 0m | 6 | `T1110.001` | 🟢 LOW |
| `18.116.101[.]220` | **6** | 2026-03-12 07:08 | 2026-03-12 07:17 | 0m | 0 | `T1592` | 🟢 LOW |
| `3.143.162[.]210` | **6** | 2026-03-12 18:22 | 2026-03-12 18:25 | 0m | 0 | `T1592` | 🟢 LOW |
...
| `167.71.142[.]172` | **4** | 2026-03-12 16:05 | 2026-03-12 16:13 | 0m | 3 | `T1110.001 · T1592` | 🟢 LOW |
| `209.38.238[.]207` | **4** | 2026-03-12 15:39 | 2026-03-12 15:46 | 0m | 3 | `T1110.001 · T1592` | 🟢 LOW |
...
| `13.89.124[.]219` | **2** | 2026-03-12 15:22 | 2026-03-12 15:22 | 0m | 0 | `T1592` | 🟢 LOW |
| `170.64.157[.]123` | **2** | 2026-03-12 15:34 | 2026-03-12 15:36 | 0m | 1 | `T1110.001 · T1592` | 🟢 LOW |
...
| `20.65.195[.]32` | **2** | 2026-03-12 17:42 | 2026-03-12 17:42 | 0m | 0 | `T1592` | 🟢 LOW |
| `206.168.34[.]62` | **2** | 2026-03-12 06:41 | 2026-03-12 06:42 | 0m | 0 | `T1592` | 🟢 LOW |
| `209.38.101[.]218` | **2** | 2026-03-12 15:42 | 2026-03-12 15:44 | 0m | 1 | `T1110.001 · T1592` | 🟢 LOW |
| `101.126.55[.]179` | 1 | 2026-03-12 04:26 | 2026-03-12 04:28 | 120s | 0 | `T1592` | 🟢 LOW |
| `101.36.108[.]125` | 1 | 2026-03-12 19:57 | 2026-03-12 19:57 | 1s | 1 | `T1110.001 · T1592` | 🟢 LOW |
| `101.71.39[.]70` | 1 | 2026-03-12 03:50 | 2026-03-12 03:50 | 12s | 0 | `T1592` | 🟢 LOW |
| `111.39.147[.]81` | 1 | 2026-03-12 17:53 | 2026-03-12 17:53 | 12s | 0 | `T1592` | 🟢 LOW |
| `112.111.141[.]7` | 1 | 2026-03-12 18:03 | 2026-03-12 18:03 | 30s | 0 | `T1592` | 🟢 LOW |
| `112.196.70[.]142` | 1 | 2026-03-12 07:15 | 2026-03-12 07:15 | 1s | 1 | `T1110.001 · T1592` | 🟢 LOW |
| `112.198.133[.]117` | 1 | 2026-03-12 20:20 | 2026-03-12 20:20 | 14s | 0 | `T1592` | 🟢 LOW |
...
| `117.245.141[.]233` | 1 | 2026-03-12 20:08 | 2026-03-12 20:08 | 13s | 0 | `T1592` | 🟢 LOW |
...
| `118.131.199[.]219` | 1 | 2026-03-12 19:31 | 2026-03-12 19:32 | 30s | 0 | `T1592` | 🟢 LOW |
| `118.193.36[.]205` | 1 | 2026-03-12 15:13 | 2026-03-12 15:13 | 1s | 1 | `T1110.001 · T1592` | 🟢 LOW |
| `118.233.44[.]129` | 1 | 2026-03-12 05:14 | 2026-03-12 05:14 | 15s | 0 | `T1592` | 🟢 LOW |
| `120.1.61[.]81` | 1 | 2026-03-12 19:14 | 2026-03-12 19:16 | 120s | 0 | `T1592` | 🟢 LOW |
...
| `177.137.230[.]43` | 1 | 2026-03-12 16:52 | 2026-03-12 16:52 | 13s | 0 | `T1592` | 🟢 LOW |
...
| `180.76.105[.]108` | 1 | 2026-03-12 20:01 | 2026-03-12 20:03 | 120s | 0 | `T1592` | 🟢 LOW |
...
| `183.179.114[.]151` | 1 | 2026-03-12 18:30 | 2026-03-12 18:30 | 5s | 0 | `T1592` | 🟢 LOW |
...
| `200.124.191[.]220` | 1 | 2026-03-12 19:07 | 2026-03-12 19:07 | 31s | 0 | `T1592` | 🟢 LOW |
| `206.0.174[.]221` | 1 | 2026-03-12 08:26 | 2026-03-12 08:26 | 13s | 0 | `T1592` | 🟢 LOW |
| `209.38.20[.]103` | 1 | 2026-03-12 19:39 | 2026-03-12 19:39 | 0s | 0 | `T1592` | 🟢 LOW |
...
| `61.43.126[.]58` | 1 | 2026-03-12 16:00 | 2026-03-12 16:00 | 13s | 0 | `T1592` | 🟢 LOW |
...
| `66.154.119[.]88` | 1 | 2026-03-12 15:17 | 2026-03-12 15:17 | 0s | 0 | `T1592` | 🟢 LOW |
...
|---|---|---|---|---|
| `118.193.39[.]99` | HK | UCLOUD INFORMATION TECHNOLOGY (HK) LIMITED | **100** ⚠️ | 7 |
| `101.126.55[.]179` | CN | Beijing Volcano Engine Technology Co., Ltd. | **100** ⚠️ | 50 |
| `151.40.73[.]173` | IT | WIND TRE S.P.A. | **100** ⚠️ | 0 |
| `72.201.174[.]12` | US | Cox Communications | **100** ⚠️ | 2 |
| `23.97.62[.]116` | SG | Microsoft Corporation | **100** ⚠️ | 12 |
...
| `167.71.142[.]172` | GB | DigitalOcean, LLC | **100** ⚠️ | 2 |
...
| AbuseIPDB score 23 below threshold 25 | 32 |
| AbuseIPDB score 4 below threshold 25 | 1 |
| AbuseIPDB score 5 below threshold 25 | 28 |
| AbuseIPDB score 8 below threshold 25 | 1 |
| Mass-scanner pattern: no commands, no downloads, ≤2 login attempts | 116 |
...
| Tool 26 | Incident Timeline Generator | ✅ 721 session(s) |
| Tool 27 | Threat Intel Feeder         | ✅ 167 IP(s) enriched |
| Tool 29 | False Positive Tracker      | ✅ 252 filtered (34.9%) |
| Tool 30 | Metric Exporter             | ✅ stats.json written |
| Tool 31 | Malware Analyzer            | ✅ 3 file(s) analyzed |
| Tool 28 | SOC Handover Report         | ✅ This report |

> **Report grouping:** 59 priority case(s) shown individually · 110 recon entry/entries in table (43 group(s) consolidating 343 session(s)).
...
_Report time: 2026-03-12T20:32:43Z_
