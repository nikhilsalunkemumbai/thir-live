...
| **Generated At** | 2026-03-13T14:41:15Z |
...
| Confirmed Threats | **298** |
| False Positives Filtered | **117** (28.2%) |
| Unique Attacker IPs | **140** |
...
### 🔴 HIGH · IR-37a14184a11b

| Field | Detail |
|---|---|
| **Source IP** | `112.78.1[.]94` |
| **First Seen** | 2026-03-13 13:42 |
| **Last Seen** | 2026-03-13 13:42 |
| **Session Duration** | 3s |
| **Login Attempts** | 1 |
| **Auth Success** | ✅ Yes — session established |
| **Commands Executed** | `cd ~; chattr -ia .ssh; lockr -ia .ssh, cd ~ && rm -rf .ssh && mkdir .ssh && echo "ssh-rsa  mdrfckr">>.ssh/authorized_keys && chmod -R go= ~/.ssh && cd ~` |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-13 13:42:46` | `cowrie.session.connect` |
| `2026-03-13 13:42:46` | `cowrie.client.version` |
| `2026-03-13 13:42:46` | `cowrie.client.kex` |
| `2026-03-13 13:42:46` | `cowrie.login.success` |
| `2026-03-13 13:42:46` | `cowrie.session.params` |
| `2026-03-13 13:42:46` | `cowrie.command.input` |
| `2026-03-13 13:42:46` | `cowrie.command.failed` |
| `2026-03-13 13:42:46` | `cowrie.log.closed` |
| `2026-03-13 13:42:47` | `cowrie.session.params` |
| `2026-03-13 13:42:47` | `cowrie.command.input` |
| `2026-03-13 13:42:47` | `cowrie.session.file_download` |
| `2026-03-13 13:42:47` | `cowrie.log.closed` |
| `2026-03-13 13:42:49` | `cowrie.session.closed` |

**Recommended Actions:**
- [ ] Submit `112.78.1[.]94` to AbuseIPDB if not already reported
- [ ] Block `112.78.1[.]94` at perimeter firewall / security group
- [ ] Review commands for lateral movement indicators
- [ ] Submit download hash(es) to VirusTotal
- [ ] Escalate to Tier 2 if pattern repeats next shift

### 🔴 HIGH · IR-656e8c5b3cf4
...
| Time (UTC) | Event |
|---|---|
| `2026-03-13 13:42:49` | `cowrie.session.connect` |
| `2026-03-13 13:42:49` | `cowrie.client.version` |
| `2026-03-13 13:42:49` | `cowrie.client.kex` |
| `2026-03-13 13:42:49` | `cowrie.login.success` |
| `2026-03-13 13:42:49` | `cowrie.session.closed` |
...
### 🔴 HIGH · IR-03d31ca4ec8f

| Field | Detail |
|---|---|
| **Source IP** | `112.78.1[.]94` |
| **First Seen** | 2026-03-13 13:49 |
| **Last Seen** | 2026-03-13 13:49 |
| **Session Duration** | 3s |
| **Login Attempts** | 1 |
| **Auth Success** | ✅ Yes — session established |
| **Commands Executed** | `cd ~; chattr -ia .ssh; lockr -ia .ssh, cd ~ && rm -rf .ssh && mkdir .ssh && echo "ssh-rsa  mdrfckr">>.ssh/authorized_keys && chmod -R go= ~/.ssh && cd ~` |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-13 13:49:49` | `cowrie.session.connect` |
| `2026-03-13 13:49:49` | `cowrie.client.version` |
| `2026-03-13 13:49:49` | `cowrie.client.kex` |
| `2026-03-13 13:49:50` | `cowrie.login.success` |
| `2026-03-13 13:49:50` | `cowrie.session.params` |
| `2026-03-13 13:49:50` | `cowrie.command.input` |
| `2026-03-13 13:49:50` | `cowrie.command.failed` |
| `2026-03-13 13:49:50` | `cowrie.log.closed` |
| `2026-03-13 13:49:50` | `cowrie.session.params` |
| `2026-03-13 13:49:50` | `cowrie.command.input` |
| `2026-03-13 13:49:50` | `cowrie.session.file_download` |
| `2026-03-13 13:49:50` | `cowrie.log.closed` |
| `2026-03-13 13:49:53` | `cowrie.session.closed` |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-13 13:49:52` | `cowrie.session.connect` |
| `2026-03-13 13:49:52` | `cowrie.client.version` |
| `2026-03-13 13:49:52` | `cowrie.client.kex` |
| `2026-03-13 13:49:52` | `cowrie.login.success` |
| `2026-03-13 13:49:53` | `cowrie.session.closed` |
...
### 🔴 HIGH · IR-ad9edbb3b094

| Field | Detail |
|---|---|
| **Source IP** | `179.185.227[.]77` |
| **First Seen** | 2026-03-13 14:30 |
| **Last Seen** | 2026-03-13 14:30 |
| **Session Duration** | 10s |
| **Login Attempts** | 1 |
| **Auth Success** | ✅ Yes — session established |
| **TCP Tunnel** | ⚠️ `cowrie.direct-tcpip` — port forwarding / proxy attempt |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-13 14:30:37` | `cowrie.session.connect` |
| `2026-03-13 14:30:38` | `cowrie.client.version` |
| `2026-03-13 14:30:38` | `cowrie.client.kex` |
| `2026-03-13 14:30:41` | `cowrie.login.success` |
| `2026-03-13 14:30:42` | `cowrie.direct-tcpip.request` |
| `2026-03-13 14:30:47` | `cowrie.session.closed` |
...
| `112.78.1[.]94` | **12** | 2026-03-13 13:31 | 2026-03-13 14:01 | 0m | 12 | `T1110.001 · T1592` | 🟠 MEDIUM |
...
| `20.64.104[.]235` | **2** | 2026-03-13 12:58 | 2026-03-13 12:58 | 0m | 0 | `T1592` | 🟢 LOW |
...
| `49.124.153[.]4` | 1 | 2026-03-13 13:32 | 2026-03-13 13:32 | 0s | 0 | `T1592` | 🟢 LOW |
...
| `151.33.113[.]95` | IT | WIND | **100** ⚠️ | 5 |
| `124.244.135[.]38` | HK | Hong Kong Broadband Network Ltd | **100** ⚠️ | 11 |
| `183.82.126[.]193` | IN | ACT HYD | **100** ⚠️ | 50 |
...
| `115.190.97[.]18` | CN | Beijing Volcano Engine Technology Co., Ltd. | **100** ⚠️ | 36 |
| `59.120.105[.]236` | TW | Chunghwa Telecom Co.,Ltd. | **100** ⚠️ | 19 |
...
## 🔕 False Positive Summary (117 filtered)
...
| Mass-scanner pattern: no commands, no downloads, ≤2 login attempts | 53 |
...
| Tool 26 | Incident Timeline Generator | ✅ 415 session(s) |
| Tool 27 | Threat Intel Feeder         | ✅ 140 IP(s) enriched |
| Tool 29 | False Positive Tracker      | ✅ 117 filtered (28.2%) |
| Tool 30 | Metric Exporter             | ✅ stats.json written |
| Tool 31 | Malware Analyzer            | ✅ 3 file(s) analyzed |
| Tool 28 | SOC Handover Report         | ✅ This report |

> **Report grouping:** 36 priority case(s) shown individually · 82 recon entry/entries in table (24 group(s) consolidating 204 session(s)).
...
_Report time: 2026-03-13T14:41:15Z_
