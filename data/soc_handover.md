...
| Field | Detail |
|---|---|
| **Source IP** | `103.174.102.89` |
| **First Seen** | 2026-03-07T19:30:43.003282Z |
| **Last Seen** | 2026-03-07T19:30:43.004153Z |
| **Session Duration** | 0s |
| **Login Attempts** | 0 |
| **Auth Success** | ❌ No |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-07 19:30:43` | `cowrie.session.connect` |
| `2026-03-07 19:30:43` | `cowrie.session.closed` |

**Recommended Actions:**
- [ ] Monitor for repeat activity from `103.174.102.89`
- [ ] No immediate escalation required
...
| **First Seen** | 2026-03-07T19:37:28.970736Z |
| **Last Seen** | 2026-03-07T19:37:29.219077Z |
| **Session Duration** | 0s |
| **Login Attempts** | 0 |
| **Auth Success** | ❌ No |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-07 19:37:28` | `cowrie.session.connect` |
| `2026-03-07 19:37:29` | `cowrie.session.closed` |

**Recommended Actions:**
- [ ] Monitor for repeat activity from `45.33.12.214`
- [ ] No immediate escalation required
...
| Field | Detail |
|---|---|
| **Source IP** | `116.140.209.208` |
| **First Seen** | 2026-03-07T19:51:07.596415Z |
| **Last Seen** | 2026-03-07T19:53:07.623399Z |
| **Session Duration** | 120s |
| **Login Attempts** | 0 |
| **Auth Success** | ❌ No |
| **TTPs (MITRE)** | T1592 |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-07 19:51:07` | `cowrie.session.connect` |
| `2026-03-07 19:51:07` | `cowrie.client.version` |
| `2026-03-07 19:53:07` | `cowrie.session.closed` |

**Recommended Actions:**
- [ ] Monitor for repeat activity from `116.140.209.208`
- [ ] No immediate escalation required
...
|---|---|
| **Source IP** | `101.200.236.207` |
| **First Seen** | 2026-03-07T19:58:13.869902Z |
| **Last Seen** | 2026-03-07T19:58:44.570023Z |
| **Session Duration** | 30s |
| **Login Attempts** | 0 |
| **Auth Success** | ❌ No |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-07 19:58:13` | `cowrie.session.connect` |
| `2026-03-07 19:58:44` | `cowrie.session.closed` |
...
| **First Seen** | 2026-03-07T20:16:08.045265Z |
| **Last Seen** | 2026-03-07T20:16:08.046599Z |
| **Session Duration** | 0s |
| **Login Attempts** | 0 |
| **Auth Success** | ❌ No |
| **TTPs (MITRE)** | T1592 |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-07 20:16:08` | `cowrie.session.connect` |
| `2026-03-07 20:16:08` | `cowrie.client.version` |
| `2026-03-07 20:16:08` | `cowrie.session.closed` |

**Recommended Actions:**
- [ ] Monitor for repeat activity from `66.228.53.162`
- [ ] No immediate escalation required
...
|---|---|
| **Source IP** | `66.228.53.162` |
| **First Seen** | 2026-03-07T20:16:08.502214Z |
| **Last Seen** | 2026-03-07T20:16:08.503599Z |
| **Session Duration** | 0s |
| **Login Attempts** | 0 |
| **Auth Success** | ❌ No |
| **TTPs (MITRE)** | T1592 |
...
|---|---|
| **Source IP** | `103.174.102.89` |
| **First Seen** | 2026-03-07T20:19:29.023770Z |
| **Last Seen** | 2026-03-07T20:19:30.044632Z |
| **Session Duration** | 1s |
| **Login Attempts** | 1 |
| **Auth Success** | ❌ No |
| **TTPs (MITRE)** | T1110.001 · T1592 |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-07 20:19:29` | `cowrie.session.connect` |
| `2026-03-07 20:19:29` | `cowrie.client.version` |
| `2026-03-07 20:19:29` | `cowrie.client.kex` |
| `2026-03-07 20:19:29` | `cowrie.login.failed` |
| `2026-03-07 20:19:30` | `cowrie.session.closed` |

**Recommended Actions:**
- [ ] Monitor for repeat activity from `103.174.102.89`
- [ ] No immediate escalation required

### 🔴 HIGH · IR-4e1376a839c3

| Field | Detail |
|---|---|
| **Source IP** | `103.174.102.89` |
| **First Seen** | 2026-03-07T20:19:30.047194Z |
| **Last Seen** | 2026-03-07T20:19:30.092288Z |
| **Session Duration** | 0s |
| **Login Attempts** | 1 |
| **Auth Success** | ✅ Yes — session established |
| **Commands Executed** | `uname -a` |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-07 20:19:30` | `cowrie.session.connect` |
| `2026-03-07 20:19:30` | `cowrie.client.version` |
| `2026-03-07 20:19:30` | `cowrie.client.kex` |
| `2026-03-07 20:19:30` | `cowrie.login.success` |
| `2026-03-07 20:19:30` | `cowrie.session.params` |
| `2026-03-07 20:19:30` | `cowrie.command.input` |
| `2026-03-07 20:19:30` | `cowrie.log.closed` |
| `2026-03-07 20:19:30` | `cowrie.session.closed` |

**Recommended Actions:**
- [ ] Submit `103.174.102.89` to AbuseIPDB if not already reported
- [ ] Block `103.174.102.89` at perimeter firewall / security group
- [ ] Review commands for lateral movement indicators
- [ ] Escalate to Tier 2 if pattern repeats next shift
...
| Field | Detail |
|---|---|
| **Source IP** | `49.142.149.113` |
| **First Seen** | 2026-03-07T21:00:43.876233Z |
| **Last Seen** | 2026-03-07T21:00:57.712645Z |
| **Session Duration** | 13s |
| **Login Attempts** | 0 |
| **Auth Success** | ❌ No |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-07 21:00:43` | `cowrie.session.connect` |
| `2026-03-07 21:00:57` | `cowrie.session.closed` |

**Recommended Actions:**
- [ ] Monitor for repeat activity from `49.142.149.113`
- [ ] No immediate escalation required
...
| Field | Detail |
|---|---|
| **Source IP** | `61.43.126.58` |
| **First Seen** | 2026-03-07T21:09:55.333962Z |
| **Last Seen** | 2026-03-07T21:10:07.938214Z |
| **Session Duration** | 12s |
| **Login Attempts** | 0 |
| **Auth Success** | ❌ No |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-07 21:09:55` | `cowrie.session.connect` |
| `2026-03-07 21:10:07` | `cowrie.session.closed` |

**Recommended Actions:**
- [ ] Monitor for repeat activity from `61.43.126.58`
- [ ] No immediate escalation required
...
|---|---|
| **Source IP** | `139.19.117.130` |
| **First Seen** | 2026-03-07T21:12:35.225322Z |
| **Last Seen** | 2026-03-07T21:12:45.225451Z |
| **Session Duration** | 10s |
| **Login Attempts** | 2 |
| **Auth Success** | ❌ No |
| **TTPs (MITRE)** | T1110.001 · T1592 |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-07 21:12:35` | `cowrie.session.connect` |
| `2026-03-07 21:12:35` | `cowrie.client.version` |
| `2026-03-07 21:12:35` | `cowrie.client.kex` |
| `2026-03-07 21:12:35` | `cowrie.client.fingerprint` |
| `2026-03-07 21:12:35` | `cowrie.login.failed` |
| `2026-03-07 21:12:35` | `cowrie.client.fingerprint` |
| `2026-03-07 21:12:35` | `cowrie.login.failed` |
| `2026-03-07 21:12:45` | `cowrie.session.closed` |
...
| Field | Detail |
|---|---|
| **Source IP** | `88.247.90.128` |
| **First Seen** | 2026-03-07T21:47:54.904243Z |
| **Last Seen** | 2026-03-07T21:48:15.658862Z |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-07 21:47:54` | `cowrie.session.connect` |
| `2026-03-07 21:48:15` | `cowrie.session.closed` |

**Recommended Actions:**
- [ ] Monitor for repeat activity from `88.247.90.128`
- [ ] No immediate escalation required
...
| Field | Detail |
|---|---|
| **Source IP** | `110.38.194.15` |
| **First Seen** | 2026-03-07T22:14:51.531602Z |
| **Last Seen** | 2026-03-07T22:15:06.065561Z |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-07 22:14:51` | `cowrie.session.connect` |
| `2026-03-07 22:15:06` | `cowrie.session.closed` |

**Recommended Actions:**
- [ ] Monitor for repeat activity from `110.38.194.15`
- [ ] No immediate escalation required
...
|---|---|
| **Source IP** | `120.241.79.66` |
| **First Seen** | 2026-03-07T22:17:40.013506Z |
| **Last Seen** | 2026-03-07T22:19:40.115310Z |
| **Session Duration** | 120s |
| **Login Attempts** | 0 |
| **Auth Success** | ❌ No |
| **TTPs (MITRE)** | T1592 |
...
| Time (UTC) | Event |
|---|---|
| `2026-03-07 22:17:40` | `cowrie.session.connect` |
| `2026-03-07 22:17:40` | `cowrie.client.version` |
| `2026-03-07 22:19:40` | `cowrie.session.closed` |
