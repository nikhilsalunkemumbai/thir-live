...
| **Generated At** | 2026-06-19T23:02:15Z |
...
| False Positives Filtered | **4** (7.4%) |
...
|---|---|---|---|
| `root` | `Lh123456` | `41.93.28.23` | 2026-06-19T21:27:12 |
| `root` | `3245gs5662d34` | `41.93.28.23` | 2026-06-19T21:27:19 |
| `root` | `abc2024` | `104.9.60.148` | 2026-06-19T22:04:20 |
| `root` | `3245gs5662d34` | `104.9.60.148` | 2026-06-19T22:04:37 |
| `root` | `abcd123` | `179.184.85.167` | 2026-06-19T22:21:27 |
...
```
Source IPs: `41.93.28.23`, `104.9.60.148`
...
### 🔴 HIGH · IR-b683695ea3cd

| Field | Detail |
|---|---|
| **Source IP** | `41.93.28[.]23` |
| **First Seen** | 2026-06-19 21:27 |
| **Last Seen** | 2026-06-19 21:27 |
| **Session Duration** | 8s |
| **Login Attempts** | 1 |
...
| Time (UTC) | Event |
|---|---|
| `2026-06-19 21:27:11` | `cowrie.session.connect` |
| `2026-06-19 21:27:11` | `cowrie.client.version` |
| `2026-06-19 21:27:11` | `cowrie.client.kex` |
| `2026-06-19 21:27:12` | `cowrie.login.success` |
| `2026-06-19 21:27:13` | `cowrie.session.params` |
| `2026-06-19 21:27:13` | `cowrie.command.input` |
| `2026-06-19 21:27:13` | `cowrie.command.failed` |
| `2026-06-19 21:27:14` | `cowrie.log.closed` |
| `2026-06-19 21:27:14` | `cowrie.session.params` |
| `2026-06-19 21:27:14` | `cowrie.command.input` |
| `2026-06-19 21:27:14` | `cowrie.session.file_download` |
| `2026-06-19 21:27:14` | `cowrie.log.closed` |
| `2026-06-19 21:27:20` | `cowrie.session.closed` |
...
| Time (UTC) | Event |
|---|---|
| `2026-06-19 21:27:18` | `cowrie.session.connect` |
| `2026-06-19 21:27:18` | `cowrie.client.version` |
| `2026-06-19 21:27:18` | `cowrie.client.kex` |
| `2026-06-19 21:27:19` | `cowrie.login.success` |
| `2026-06-19 21:27:20` | `cowrie.session.closed` |
...
### 🔴 HIGH · IR-b6dd846cdd37

| Field | Detail |
|---|---|
| **Source IP** | `104.9.60[.]148` |
| **First Seen** | 2026-06-19 22:04 |
| **Last Seen** | 2026-06-19 22:04 |
...
| Time (UTC) | Event |
|---|---|
| `2026-06-19 22:04:18` | `cowrie.session.connect` |
| `2026-06-19 22:04:18` | `cowrie.client.version` |
| `2026-06-19 22:04:18` | `cowrie.client.kex` |
| `2026-06-19 22:04:20` | `cowrie.login.success` |
| `2026-06-19 22:04:20` | `cowrie.session.params` |
| `2026-06-19 22:04:20` | `cowrie.command.input` |
| `2026-06-19 22:04:20` | `cowrie.command.failed` |
| `2026-06-19 22:04:21` | `cowrie.log.closed` |
| `2026-06-19 22:04:21` | `cowrie.session.params` |
| `2026-06-19 22:04:21` | `cowrie.command.input` |
| `2026-06-19 22:04:21` | `cowrie.session.file_download` |
| `2026-06-19 22:04:21` | `cowrie.log.closed` |
| `2026-06-19 22:04:37` | `cowrie.session.closed` |

**Recommended Actions:**
- [ ] Submit `104.9.60[.]148` to AbuseIPDB if not already reported
- [ ] Block `104.9.60[.]148` at perimeter firewall / security group
- [ ] Review commands for lateral movement indicators
- [ ] Submit download hash(es) to VirusTotal
- [ ] Escalate to Tier 2 if pattern repeats next shift

### 🔴 HIGH · IR-2c30c91eeb42
...
| Time (UTC) | Event |
|---|---|
| `2026-06-19 22:04:36` | `cowrie.session.connect` |
| `2026-06-19 22:04:36` | `cowrie.client.version` |
| `2026-06-19 22:04:36` | `cowrie.client.kex` |
| `2026-06-19 22:04:37` | `cowrie.login.success` |
| `2026-06-19 22:04:37` | `cowrie.session.closed` |
...
### 🔴 HIGH · IR-16e206979de2

| Field | Detail |
|---|---|
| **Source IP** | `179.184.85[.]167` |
| **First Seen** | 2026-06-19 22:21 |
| **Last Seen** | 2026-06-19 22:21 |
| **Session Duration** | 9s |
| **Login Attempts** | 1 |
| **Auth Success** | ✅ Yes — session established |
...
| Time (UTC) | Event |
|---|---|
| `2026-06-19 22:21:24` | `cowrie.session.connect` |
| `2026-06-19 22:21:25` | `cowrie.client.version` |
| `2026-06-19 22:21:25` | `cowrie.client.kex` |
| `2026-06-19 22:21:27` | `cowrie.login.success` |
| `2026-06-19 22:21:28` | `cowrie.direct-tcpip.request` |
| `2026-06-19 22:21:33` | `cowrie.session.closed` |
...
|---|---|---|---|---|---|---|---|
| `110.37.115[.]91` | **25** | 2026-06-19 22:39 | 2026-06-19 22:44 | 5m | 0 | `T1592` | 🟠 MEDIUM |
| `216.144.229[.]11` | **8** | 2026-06-19 21:31 | 2026-06-19 22:49 | 4m | 0 | `T1592` | 🟢 LOW |
| `134.209.241[.]3` | **5** | 2026-06-19 22:14 | 2026-06-19 22:31 | 5m | 0 | `T1592` | 🟢 LOW |
| `134.122.23[.]93` | 1 | 2026-06-19 22:29 | 2026-06-19 22:29 | 12s | 0 | `T1592` | 🟢 LOW |
| `136.0.54[.]70` | 1 | 2026-06-19 22:15 | 2026-06-19 22:16 | 30s | 0 | `T1592` | 🟢 LOW |
| `221.146.118[.]189` | 1 | 2026-06-19 22:29 | 2026-06-19 22:29 | 14s | 0 | `T1592` | 🟢 LOW |
| `41.93.28[.]23` | 1 | 2026-06-19 21:27 | 2026-06-19 21:27 | 2s | 1 | `T1110.001 · T1592` | 🟢 LOW |
| `59.46.182[.]10` | 1 | 2026-06-19 21:39 | 2026-06-19 21:39 | 17s | 0 | `T1592` | 🟢 LOW |
| `59.98.41[.]27` | 1 | 2026-06-19 21:22 | 2026-06-19 21:22 | 6s | 1 | `T1110.001 · T1592` | 🟢 LOW |
| `90.68.129[.]147` | 1 | 2026-06-19 22:26 | 2026-06-19 22:26 | 13s | 0 | `T1592` | 🟢 LOW |
...
| `221.146.118[.]189` | KR | Korea Telecom | **100** ⚠️ | 1 |
| `216.144.229[.]11` | US | HostPapa | **100** ⚠️ | 6 |
| `59.98.41[.]27` | IN | Broadband Multiplay Project, O/o DGM BB, NOC BSNL Bangalore | **100** ⚠️ | 5 |
| `134.209.241[.]3` | DE | DigitalOcean, LLC | **100** ⚠️ | 3 |
| `136.0.54[.]70` | TW | Ace Data Centers II, L.L.C. | **100** ⚠️ | 2 |
| `179.184.85[.]167` | BR | TELEFÔNICA BRASIL S.A | **100** ⚠️ | 50 |
| `104.9.60[.]148` | US | AT&T Enterprises, LLC | **100** ⚠️ | 7 |
| `90.68.129[.]147` | ES | Orange Spain Network | **100** ⚠️ | 9 |
...
| Tool 29  | False Positive Tracker      | ✅ 4 filtered (7.4%) |
...
> **Report grouping:** 5 priority case(s) shown individually · 10 recon entry/entries in table (3 group(s) consolidating 38 session(s)).
...
_Report time: 2026-06-19T23:02:15Z_
